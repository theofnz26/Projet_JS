...
function createPage() {                                                                 // Fonction principale de génération du site
    ...
    const aboutSection = createAndStyleElement('div', 'section', `
            ...
            <p>
                Ce site est un projet pédagogique réalisé pour explorer et mettre en pratique les fonctionnalités du JavaScript moderne appliqué au DOM. Il propose plusieurs modules interactifs :
            </p>
            <ul>
                <li><strong>Accueil :</strong> Un compteur de clics dynamique pour illustrer la manipulation d'événements et la mise à jour du DOM en temps réel.</li>
                <li><strong>Feed :</strong> Un fil d'actualité permettant d'ajouter des posts et de récupérer des données depuis une API externe, pour s'entraîner à l'asynchrone et à la gestion de formulaires.</li>
                <li><strong>Galerie :</strong> Une galerie d'images dynamique avec possibilité d'ajouter ses propres images, pour expérimenter la gestion de fichiers et l'affichage conditionnel.</li>
                <li><strong>Réseaux :</strong> Un menu déroulant vers différents réseaux sociaux, pour travailler sur la navigation et l'accessibilité.</li>
            </ul>
            <p>
                L'objectif de ce site est de consolider les compétences en JavaScript, en DOM, et en conception d'interfaces interactives. Il a été conçu pour être simple, évolutif et facilement compréhensible, afin de servir de base à d'autres projets ou exercices.
            </p>
        `);       // Section À propos
